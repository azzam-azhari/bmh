    ...
    <section className="py-12 sm:py-16 lg:py-20">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold leading-tight text-[#095046] sm:text-4xl xl:text-5xl font-pj">Kenapa Harus Kami</h2>
        ...
        <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
          <div className="md:p-8 lg:p-14">
            <svg className="mx-auto" width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M45 29V23C45 10.85 35.15 1 23 1C10.85 1 1 10.85 1 23V29" stroke="#095046" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M13 29H1V41C1 43.209 2.791 45 5 45H13V29Z" fill="#9aa8a6ff" stroke="#095046" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M45 29H33V45H41C43.209 45 45 43.209 45 41V29Z" fill="#9aa8a6ff" stroke="#095046" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            <h3 className="mt-12 text-xl font-bold text-[#39BA87] font-pj">Support</h3>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
            ...
            <h3 className="mt-12 text-xl font-bold text-[#39BA87] font-pj">Sales</h3>
            <p className="mt-5 text-base text-gray-600 font-pj">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
            ...
            <h3 className="mt-12 text-xl font-bold text-[#39BA87] font-pj">Onboarding</h3>
            <p className="mt-5 text-base text-gray-600 font-pj">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200">
            ...
            <h3 className="mt-12 text-xl font-bold text-[#39BA87] font-pj">Product</h3>
            <p className="mt-5 text-base text-gray-600 font-pj">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
            ...
            <h3 className="mt-12 text-xl font-bold text-[#39BA87] font-pj">Quality</h3>
            <p className="mt-5 text-base text-gray-600 font-pj">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
            ...
            <h3 className="mt-12 text-xl font-bold text-[#39BA87] font-pj">Result</h3>
            <p className="mt-5 text-base text-gray-600 font-pj">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
          </div>
        </div>
      </div>
