    ...
    <section className="container py-20 mx-auto font-poppins bg-slate-50 lg:py-30 max-w-7xl">
      ...
      <div className="text-left lg:text-left">
        ...
        <div className="flex flex-col gap-2 mt-2 w-70">
          <a href="https://wa.me/18002428478?text=Halo" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 transition rounded-xl bg-slate-200 hover:bg-slate-300">
            WhatsApp: 18002428478
          </a>
          <a href="mailto:" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 transition rounded-xl bg-slate-200 hover:bg-slate-300">
            Email: csjakarta@bmh.or.id
          </a>
        </div>
