      ...
      <div className="relative w-full px-6 isolate lg:px-8">
        ...
        <div aria-hidden="true" className="absolute inset-x-0 overflow-hidden -top-40 -z-10 transform-gpu blur-3xl sm:-top-80">
          <div
            ...
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ffbd4c] to-[#53ffba] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72rem]"
          />
        </div>
        ...
        <div className="flex flex-col items-center justify-center max-w-4xl min-h-[70vh] mx-auto text-center">
          ...
          {/* Judul */}
          <h1 className="max-w-3xl mx-auto text-4xl font-semibold leading-snug tracking-tight text-gray-900 text-balance sm:text-3xl md:text-4xl lg:text-5xl">
        ...
        <div aria-hidden="true" className="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]">
          <div
            ...
            className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36rem] -translate-x-1/2 bg-gradient-to-tr from-[#ffc259] to-[#4cffb7] opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72rem]"
          />
        </div>
      </div>
    </div>
