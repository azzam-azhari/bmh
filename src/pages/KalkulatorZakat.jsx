        ...
        <div className="flex flex-wrap justify-center gap-4">
          {['Penghasilan (Profesi)', 'Tabungan (Maal)', 'Perdagangan', 'Emas'].map((type) => (
            <button
              ...
              className={`border px-5 py-2 rounded-md flex items-center gap-2 transition-all ${
                selectedType === type ? 'border-green-400 text-[#39BA87] font-bold hover:border-[#39BA87]' : 'border-gray-200 text-black hover:cursor-pointer hover:text-[#095046] hover:border-[#095046]'
              }`}
            >
              {type}
            </button>
