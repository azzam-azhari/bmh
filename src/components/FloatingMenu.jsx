...
const FloatingMenu = () => {
  ...
  return (
    <a
      ...
      className="fixed z-50 flex items-center justify-start overflow-hidden text-white transition-all duration-300 ease-in-out bg-yellow-400 shadow-lg  group bottom-24 right-6 w-14 hover:w-64 h-14 rounded-xl"
