    ...
    <div className={`fixed top-0 left-0 z-50 w-full transition-all duration-300 navbar font-poppins ${scroll ? 'py-2 bg-white/50 backdrop-blur-sm shadow-md' : 'py-4'}`}>
      <div className="container px-4 mx-auto md:px-8 lg:px-16">
        <div className="flex items-center justify-between text-gray-900 navbar-box">
          ...
          <ul
            ref={menuRef}
            className={`fixed ${menuActive} left-0 right-0 flex flex-col gap-8 px-8 py-6 font-medium text-slate-800 transition-all duration-500 ease-in-out bg-white lg:gap-12 md:static md:flex-row md:shadow-none md:bg-transparent md:w-auto md:h-full md:top-0 md:translate-y-0 md:text-slate-700 md:p-0 md:m-0 md:transition-none z-40`}
          >
